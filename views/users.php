    ...
    <div class="main-content font-size-13">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item" href="admins.php">مدیران</a>
                <a class="tab__item" href="add_users.php">ایجاد کاربر جدید</a>
            </div>
        </div>
                ...
                <form action="search_users.php" method="get">
                    <div class="t-header-searchbox font-size-13">
                        ...
                        <div class="t-header-search-content ">
                            <input type="text" name="username" class="text margin-bottom-20" placeholder="نام کاربری  ">
                            <input type="email" name="email" class="text"  placeholder="ایمیل">
                            <input type="text" name="ip" class="text" placeholder="آی پی">
        ...
        <div class="table__box">
            <table class="table">
                <?php
                if(isset($_SESSION['masage_erore'])){
                    echo $_SESSION['masage_erore'];
                }
                unset($_SESSION['masage_erore']);
                ?>
                <thead role="rowgroup">
                ...
                <tr role="row" class="">
                    ...
                    <td>
                        <a href="../controller/user_controller.php?id=<?=  htmlspecialchars($user[0]) ?>&form-name=delete_user" class="item-delete mlg-15" title="حذف"></a>
                        <a href="edit-user.php?id=<?= htmlspecialchars($user[0]) ?>" class="item-edit " title="ویرایش"></a>
                    </td>
                </tr>
                <?php } ?>
                </tbody>
